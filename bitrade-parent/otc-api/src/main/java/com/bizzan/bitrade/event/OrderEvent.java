...
public class OrderEvent {
    ...
    public void onOrderCompleted(Order order) {
        Member member = memberDao.getById(order.getMemberId());
        member.setTransactions(member.getTransactions() + 1);
        Member member1 = memberDao.getById(order.getCustomerId());
            ...
            Arrays.stream(array).forEach(
                    x -> {
                        ...
                        if (x.getTransactions() == 1 && x.getInviterId() != null) {
                            Member member2 = memberDao.getById(x.getInviterId());
                            ...
                            if (member2.getInviterId() != null) {
                                Member member3 = memberDao.getById(member2.getInviterId());
