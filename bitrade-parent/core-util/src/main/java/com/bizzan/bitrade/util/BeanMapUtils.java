...
public class BeanMapUtils {
    ...
    public static void map2Bean(Map<String, ?> map, Object bean) throws IllegalArgumentException, IllegalAccessException {
        ...
        for (int var5 = 0; var5 < var6; ++var5) {
            ...
            if (field.isAnnotationPresent(com.bizzan.bitrade.sql.annotation.Field.class)) {
                com.bizzan.bitrade.sql.annotation.Field alias = (com.bizzan.bitrade.sql.annotation.Field) field.getAnnotation(com.bizzan.bitrade.sql.annotation.Field.class);
                key = alias.value();
            }
